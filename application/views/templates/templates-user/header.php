        ...
        <div class="container"> <a class="navbar-brand" href="<?= base_url(); ?>">Pustaka</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav">
                    ...
                    ?>
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#daftarModal" href="<?= base_url(''); ?>">
                            <i class="fas fw fa-login"></i> Daftar</a>
                        <a class="nav-item nav-link" data-toggle="modal" data-target="#loginModal" href="<?= base_url(''); ?>">
